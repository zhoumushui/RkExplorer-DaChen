...
public class NormalListAdapter extends ArrayAdapter<FileInfo>{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		else if(info.mFile.getPath().equals(sata_dir))
		...
		}else if(info.mFile.getPath().startsWith(EnumConstent.mDirNfs)){
        	text.setText(info.mDescription);
		}else
        ...
        if(info.mFile.getPath().startsWith(RockExplorer.smb_dir) || info.mFile.getPath().startsWith(EnumConstent.mDirNfs)){
        ...
        if((sdcard_dir != null) && info.mFile.getPath().endsWith(sdcard_dir) || 
        	...
        	info.mFile.getPath().endsWith(sata_dir)||
        	info.mFile.getPath().endsWith(RockExplorer.smb_dir) ||
        	info.mFile.getPath().endsWith(EnumConstent.mDirNfs) ||
        	"..".equals(info.mFileType)){
        	text_right.setText("");
        }else{        	
