...
public class FileInfo {
	...
	public String toString() {
		return "FileInfo [mFile=" + mFile + ", mIcon=" + mIcon + ", mIsDir="
				+ mIsDir + ", mFileType=" + mFileType + ", mIsSelected="
				+ mIsSelected + ", mDescription=" + mDescription + ", mUri="
				+ mUri + ", mSelectedIndex=" + mSelectedIndex + ", mUsername="
				+ mUsername + ", mPassword=" + mPassword + ", mAnonymous="
				+ mAnonymous + ", mMountpoint=" + mMountpoint + ", mIsMount="
				+ mIsMount + "]";
	}
